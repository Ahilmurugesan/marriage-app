    ...
    <section id="page-banner" class="page-banner" style="background-image: url('images/banner.jpg');">
        ...
        <div class="container">
            <div class="banner-dtl text-center">
                <h2 class="banner-heading">Latest Blogs</h2>
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="blog-block">
                        <div class="blog-img">
                            <a href="{{ route('blogDetail') }}"><img src="{{asset('images/blog-page/blog-1.jpg')}}" class="img-responsive" alt="blog-img"></a>
                            <div class="meta-tag">March 12, 2017</div>
                        </div>
                        <div class="blog-dtl">
                            <h4 class="blog-heading"><a href="{{ route('blogDetail') }}">Sed ut perspiciatis unde omnis iste natus error sit voluptat antium</a></h4>
                            ...
                            <a href="{{ route('blogDetail') }}" class="btn btn-pink">Read More</a>
                        </div>
                    </div>
                    <div class="blog-block">
                        <div class="blog-img">
                            <a href="{{ route('blogDetail') }}"><img src="{{asset('images/blog-page/blog-2.jpg')}}" class="img-responsive" alt="blog-img"></a>
                            <div class="meta-tag">March 12, 2017</div>
                        </div>
                        <div class="blog-dtl">
                            <h4 class="blog-heading"><a href="{{ route('blogDetail') }}">Ut enim ad minima veniam quis nostrum exercitationem ullam corp</a></h4>
                    ...
                    <div class="blog-block">
                        <div class="blog-img">
                            <a href="{{ route('blogDetail') }}"><img src="{{asset('images/blog-page/blog-3.jpg')}}" class="img-responsive" alt="blog-img"></a>
                            <div class="meta-tag">March 11, 2017</div>
                        </div>
                        <div class="blog-dtl">
                            <h4 class="blog-heading"><a href="{{ route('blogDetail') }}">Excepteur sint occaecat cupidatat non proident sunt in culpa qui</a></h4>
                    ...
                    <div class="blog-block">
                        <div class="blog-img">
                            <a href="{{ route('blogDetail') }}"><img src="{{asset('images/blog-page/blog-4.jpg')}}" class="img-responsive" alt="blog-img"></a>
                            <div class="meta-tag">March 10, 2017</div>
                        </div>
                        <div class="blog-dtl">
                            <h4 class="blog-heading"><a href="{{ route('blogDetail') }}">quis nostrud exercitation ullamco laboris nisi commodo consequat</a></h4>
                    ...
                    <div class="blog-block">
                        <div class="blog-img">
                            <a href="{{ route('blogDetail') }}"><img src="{{asset('images/blog-page/blog-5.jpg')}}" class="img-responsive" alt="blog-img"></a>
                            <div class="meta-tag">March 10, 2017</div>
                        </div>
                        <div class="blog-dtl">
                            <h4 class="blog-heading"><a href="{{ route('blogDetail') }}">beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia</a></h4>
                        ...
                        <div class="widget blog-latest-news">
                            ...
                            <div class="blog-news">
                                ...
                                <div class="blog-news-dtl">
                                    <h6 class="blog-news-dtl-heading"><a href="{{ route('blogDetail') }}">Veritatis et qsrch beatae vitae</a></h6>
                            ...
                            <div class="blog-news">
                                ...
                                <div class="blog-news-dtl">
                                    <h6 class="blog-news-dtl-heading"><a href="{{ route('blogDetail') }}">Numqua eius modi tempora incid</a></h6>
                                    <div class="date">March 13, 2017</div>
                                </div>
                            </div>
                            <div class="blog-news">
                                ...
                                <div class="blog-news-dtl">
                                    <h6 class="blog-news-dtl-heading"><a href="{{ route('blogDetail') }}">Vel illum qui dolo eum fugiat</a></h6>
                                    <div class="date">March 13, 2017</div>
                                </div>
                            </div>
                        </div>
